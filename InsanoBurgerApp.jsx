    ...
    <script type="text/babel">
      ...
      const CartProvider = ({ children }) => {
        ...
        const showAddedItemPopup = (name) => {
          ...
          setTimeout(() => setAddedItemName(''), 1500);
        };
      ...
      function App() {
        ...
        return (
          <>
            {/* O <style> no <head> já cuida das fontes */}
      ...
      // --- 4. COMPONENTE "ROOT" ---
      // (Não precisa de 'export default' pois está no mesmo arquivo)
      function InsanoBurgerApp() {
        return (
          <CartProvider>
            <App />
          </CartProvider>
      ...
      // --- 6. Inicia o aplicativo ---
      // (Não precisamos de 'import' pois InsanoBurgerApp está no mesmo script)
